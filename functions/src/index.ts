...
export const CalcIndivisualSuperChats = functions.runWith({timeoutSeconds: 120, memory: "512MB"}).region(REGION).pubsub.schedule("57 10 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);

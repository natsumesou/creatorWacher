...
export const CalcIndivisualSuperChats = functions.runWith({...strongRuntimeOpts, ...{timeoutSeconds: 120}}).region(REGION).pubsub.schedule("10 17 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);

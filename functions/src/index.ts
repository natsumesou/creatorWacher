...
export const CalcIndivisualSuperChats = functions.runWith({timeoutSeconds: 120, memory: "512MB"}).region(REGION).pubsub.schedule("11 11 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);

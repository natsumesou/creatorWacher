...
export const CalcIndivisualSuperChats = functions.runWith({...weakRuntimeOpts, ...{timeoutSeconds: 120}}).region(REGION).pubsub.schedule("0 9 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);

...
export const CalcIndivisualSuperChats = functions.runWith({timeoutSeconds: 120, memory: "2GB"}).region(REGION).pubsub.schedule("20 8 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);

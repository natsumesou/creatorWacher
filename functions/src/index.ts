...
export const CalcIndivisualSuperChats = functions.runWith({...strongRuntimeOpts, ...{timeoutSeconds: 120}}).region(REGION).pubsub.schedule("20 8 * * *").timeZone("Asia/Tokyo").onRun(calcIndivisualSuperChats);
